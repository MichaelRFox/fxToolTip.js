var fxToolTip = (function () {
	...
	var ordinaryToPrimitive$1 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$e(fn = input.toString) && !isObject$c(val = fn.call(input))) return val;
	  if (isCallable$e(fn = input.valueOf) && !isObject$c(val = fn.call(input))) return val;
	  if (pref !== 'string' && isCallable$e(fn = input.toString) && !isObject$c(val = fn.call(input))) return val;
	...
	var ie8DomDefine = !DESCRIPTORS$7 && !fails$k(function () {
	...
	var isObject$9 = isObject$d; // `Assert: Type(argument) is Object`
	...
	var isForced$2 = function (feature, detection) {
	  ...
	  return value == POLYFILL ? true : value == NATIVE ? false : isCallable$a(detection) ? fails$j(detection) : !!detection;
	};
	...
	*/
	...
	var aCallable$2 = aCallable$4; // optional / simple context binding
	...
	var SPECIES$3 = wellKnownSymbol$e('species'); // a part of `ArraySpeciesCreate` abstract operation
	...
	var arraySpeciesConstructor$1 = function (originalArray) {
	  ...
	  if (isArray$1(originalArray)) {
	    ...
	    if (isConstructor$1(C) && (C === Array || isArray$1(C.prototype))) C = undefined;else if (isObject$7(C)) {
	      C = C[SPECIES$3];
	...
	var FORCED$3 = 1 / $parseFloat$1(whitespaces$2 + '-0') !== -Infinity // MS Edge 18- broken with boxed symbols
	...
	var requireObjectCoercible$4 = requireObjectCoercible$8; // `String.prototype.repeat` method implementation
	// https://tc39.es/ecma262/#sec-string.prototype.repeat

	var stringRepeat = function repeat(count) {
	  var str = toString$9(requireObjectCoercible$4(this));
	  var result = '';
	...
	var FORCED$2 = nativeToFixed && (0.00008.toFixed(3) !== '0.000' || 0.9.toFixed(0) !== '1' || 1.255.toFixed(2) !== '1.25' || 1000000000000000128.0.toFixed(0) !== '1000000000000000128') || !fails$f(function () {
	  // V8 ~ Android 4.3-
	  nativeToFixed.call({});
	...
	var fails$e = fails$o;
	var global$8 = global$l; // babel-minify and Closure Compiler transpiles RegExp('a', 'y') -> /a/y and it causes SyntaxError
	...
	var fails$d = fails$o;
	var global$7 = global$l; // babel-minify and Closure Compiler transpiles RegExp('.', 's') -> /./s and it causes SyntaxError
	...
	var fails$c = fails$o;
	var global$6 = global$l; // babel-minify and Closure Compiler transpiles RegExp('(?<a>b)', 'g') -> /(?<a>b)/g and it causes SyntaxError
	...
	fixRegExpWellKnownSymbolLogic$1('replace', function (_, nativeReplace, maybeCallNative) {
	  ...
	  function replace(searchValue, replaceValue) {
	    ...
	    return replacer ? replacer.call(searchValue, O, replaceValue) : nativeReplace.call(toString$4(O), searchValue, replaceValue);
	...
	var isRegexp = function (it) {
	  var isRegExp;
	  return isObject$5(it) && ((isRegExp = it[MATCH]) !== undefined ? !!isRegExp : classof$3(it) == 'RegExp');
	};
	...
	fixRegExpWellKnownSymbolLogic('split', function (SPLIT, nativeSplit, maybeCallNative) {
	  ...
	  function split(separator, limit) {
	    ...
	    return splitter ? splitter.call(separator, O, limit) : internalSplit.call(toString$3(O), separator, limit);
	...
	var lengthOfArrayLike$2 = lengthOfArrayLike$6; // `Array.prototype.{ reduce, reduceRight }` methods implementation
	...
	var engineIsNode = classof$2(global$4.process) == 'process';
	...
	var defineIterator$2 = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
	  ...
	  if (IterablePrototype[ITERATOR$4] !== defaultIterator) {
	    redefine$3(IterablePrototype, ITERATOR$4, defaultIterator, {
	      name: DEFAULT
	    });
	  }
	...
	var classof$1 = classof$7; // `Object.prototype.toString` method implementation
	...
	if (!TO_STRING_TAG_SUPPORT) {
	  redefine$2(Object.prototype, 'toString', toString$2, {
	    unsafe: true
	  });
	}
	...
	var IS_IE11 = !global$2.ActiveXObject && 'ActiveXObject' in global$2; // eslint-disable-next-line es/no-object-isextensible -- safe
